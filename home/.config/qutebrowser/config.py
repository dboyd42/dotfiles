...
# ------------------------
# Open a captive portal page
config.unbind('ss')  # alias `:set`
config.bind('ssl', 'open -t http://neverssl.com')
...
# Source Qutebrowser's Configuration File
config.bind('\sc', 'config-source ~/.config/qutebrowser/config.py')

# Statusbar/Titlebar Show/Hide
...
# Videos
# ------
# Watch Videos Without Ads via MPV
...
config.bind('<Ctrl-w>', 'fake-key <Backspace>',            'insert')
config.bind('<Mod1-b>', 'fake-key <Ctrl-Left>',            'insert')
config.bind('<Mod1-d>', 'fake-key <Ctrl-Delete>',          'insert')
config.bind('<Mod1-f>', 'fake-key <Ctrl-Right>',           'insert')
config.bind('<Ctrl-y>', 'fake-key <insert-text {primary}', 'insert')
