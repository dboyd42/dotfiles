...
#                                                                             #
export TERM="xterm-kitty"          # Kitty Term -> alias ssh
...
# Bindkeys Key:                                                               #
#  '^[' => ALT                                                                #
#  '[Z' => Shift  *Note: Shift is not 100% compatabile                        #
#bindkey "^X^F" vi-find-next-char  # built-in default                         #
